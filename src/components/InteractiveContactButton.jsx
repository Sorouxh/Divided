...
const InteractiveContactButton = forwardRef(function InteractiveContactButton({ children = 'Contact' }, ref) {
  ...
  return (
    <motion.div
      ...
      animate={isRevealed
        ? { width: 256, height: 154, borderRadius: 16 }
      ...
      <div className="contact-card" aria-hidden={!isRevealed}>
        ...
        <div className="contact-card-row">
          <div className="contact-card-copy">
            ...
            <span className="contact-card-value">Hi@Dividedsign.com</span>
          </div>
          <button className="contact-copy-control" type="button" onClick={copyEmail} aria-label="Copy email address">
            ...
            <span className={`contact-copy-tooltip${isCopied ? ' is-visible' : ''}`} role="status">Copied</span>
          </button>
        </div>
        ...
        <a className="contact-card-row contact-instagram" href="https://instagram.com/dividedsign" target="_blank" rel="noreferrer">
          <span className="contact-card-copy">
            <span className="contact-card-eyebrow">Instagram</span>
